...
export default function EerieCorridorPage() {
  return (
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="max-w-6xl mx-auto px-6 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            <span className="text-bronze-gradient">诡异走廊</span>
          </h1>
          <p className="text-[#e8e8ec]/60 text-lg font-light max-w-2xl">
            公寓走廊场景，注重光影氛围与恐怖悬疑感营造。通过 UE5 的 Lumen 全局光照打造沉浸式的恐怖游戏场景。
          </p>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] max-w-md mx-auto">
            <div className="aspect-[9/16] relative">
              <video
                ...
                playsInline
              >
                <source src="/videos/eerie-corridor-main-v3.mp4" type="video/mp4" />
                您的浏览器不支持视频播放
              </video>
            </div>
          </div>
          <p className="text-center text-[#e8e8ec]/40 text-sm mt-4">第一人称视角</p>
          <div className="text-center mt-4">
            <p className="text-[#e8e8ec]/60 text-sm mb-2">【诡异走廊】</p>
            <a 
              href="https://www.bilibili.com/video/BV1HYV964Ekp/?share_source=copy_web&vd_source=6752ae59e5271570db93a95511fb4359"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#c4a35a] text-sm hover:underline break-all"
            >
              https://www.bilibili.com/video/BV1HYV964Ekp/
            </a>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16">
          ...
          <div className="flex justify-center gap-4">
            <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] group w-56">
              <div className="aspect-[9/16] relative overflow-hidden">
                <Image
                  src="/eerie-corridor-render1.png"
                  alt="渲染图1"
                  fill
            ...
            <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] group w-56">
              <div className="aspect-[9/16] relative overflow-hidden">
                <Image
                  src="/eerie-corridor-render3.png"
                  alt="渲染图3"
                  fill
                  className="object-fill transition-transform duration-700 group-hover:scale-105"
                />
            ...
            <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] group w-56">
              <div className="aspect-[9/16] relative overflow-hidden">
                <Image
                  src="/eerie-corridor-render4.png"
                  alt="渲染图4"
                  fill
                  className="object-fill transition-transform duration-700 group-hover:scale-105"
                />
            ...
            <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] group w-56">
              <div className="aspect-[9/16] relative overflow-hidden">
                <Image
                  src="/eerie-corridor-render5.png"
                  alt="渲染图5"
                  fill
                  className="object-fill transition-transform duration-700 group-hover:scale-105"
                />
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16">
          ...
          <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02]">
            <div className="aspect-video relative">
              <Image
                src="/eerie-corridor-process.gif"
                alt="制作过程"
                fill
            ...
            <div className="p-4 border-t border-white/5">
              <p className="text-[#e8e8ec]/60 text-sm">场景搭建与材质调整过程</p>
            </div>
          </div>
        </section>
