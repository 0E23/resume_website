...
export default function MysteriousCavePage() {
  return (
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="max-w-6xl mx-auto px-6 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            <span className="text-bronze-gradient">神秘山洞</span>
          </h1>
          <p className="text-[#e8e8ec]/60 text-lg font-light max-w-2xl">
            神秘山洞场景，注重光影氛围与神秘感营造，通过 UE5 的 Lumen 全局光照打造逼真的洞穴环境。
          </p>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] max-w-[84rem] mx-auto">
            <div className="aspect-video relative">
              <video
                ...
                playsInline
              >
                <source src="/videos/mysterious-cave-main.mp4" type="video/mp4" />
                您的浏览器不支持视频播放
              </video>
            </div>
          </div>
          <p className="text-center text-[#e8e8ec]/40 text-sm mt-4">固定镜头视角</p>
          <div className="text-center mt-4">
            <p className="text-[#e8e8ec]/60 text-sm mb-2">【不知名山洞】</p>
            <a href="https://www.bilibili.com/video/BV1iKNP6pE9W/?share_source=copy_web&vd_source=6752ae59e5271570db93a95511fb4359" target="_blank" rel="noopener noreferrer" className="text-[#c4a35a] text-sm hover:underline break-all">
              https://www.bilibili.com/video/BV1iKNP6pE9W/
            </a>
          </div>
        </section>
          ...
          <div className="flex justify-center gap-4">
            <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] group w-[72rem]">
              <div className="aspect-video relative overflow-hidden">
                <Image
                src="/mysterious-cave-render1.jpg"
                alt="渲染图1"
                fill
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16">
          ...
          <div className="flex justify-center gap-4">
            <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] group w-[72rem]">
              <div className="aspect-video relative overflow-hidden">
                <Image
                src="/mysterious-cave-process.gif"
                alt="制作过程"
                fill
                className="object-fill transition-transform duration-700 group-hover:scale-105"
              />
          ...
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <p className="text-[#e8e8ec]">游戏场景</p>
              </div>
              <div>
