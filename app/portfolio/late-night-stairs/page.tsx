...
export default function LateNightStairsPage() {
  return (
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="max-w-6xl mx-auto px-6 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            <span className="text-bronze-gradient">深夜楼梯间</span>
          </h1>
          <p className="text-[#e8e8ec]/60 text-lg font-light max-w-2xl">
            现代建筑楼梯间场景，冷色调灯光设计营造悬疑氛围。通过 UE5 的 Lumen 全局光照技术，展现深夜独处时的压抑与神秘感。
          </p>
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16">
          <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] max-w-md mx-auto">
            <div className="aspect-[3/4] relative">
              <video
                ...
                playsInline
              >
                <source src="/videos/late-night-stairs-main-v2.mp4" type="video/mp4" />
                您的浏览器不支持视频播放
              </video>
            </div>
          </div>
          ...
          <div className="text-center mt-4">
            <p className="text-[#e8e8ec]/60 text-sm mb-2">【深夜楼梯间】</p>
            <a 
              href="https://www.bilibili.com/video/BV1HYV964EHJ/?share_source=copy_web&vd_source=6752ae59e5271570db93a95511fb4359"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#c4a35a] text-sm hover:underline break-all"
            >
              https://www.bilibili.com/video/BV1HYV964EHJ/
            </a>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16">
          ...
          <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02]">
            <div className="aspect-video relative">
              <Image
                src="/late-night-stairs-process.gif"
                alt="制作过程"
                fill
