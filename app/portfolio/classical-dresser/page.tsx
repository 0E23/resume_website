...
export default function ClassicalDresserPage() {
  return (
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="max-w-6xl mx-auto px-6 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            <span className="text-bronze-gradient">古典橱柜</span>
          </h1>
          <p className="text-[#e8e8ec]/60 text-lg font-light max-w-2xl">
            木制古典橱柜模型，在MAYA创建 LOW模 拆分 UV。在Substance Designer 创建纹理细节展示材质细节，呈现古典家具的温润质感与历史韵味。
          </p>
        ...
        {/* 破旧电话亭 */}
        <section className="max-w-6xl mx-auto px-6 mb-16">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 text-bronze-gradient">破旧电话亭</h2>
          <p className="text-[#e8e8ec]/60 text-lg font-light max-w-2xl mb-4">
            电话亭模型，在MAYA创建简单面片模型 拆分 UV。在Substance Designer 创建纹理细节展示材质细节，省区Low模-Hight模-烘焙等一系列传统PBR流程。
          </p>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02]">
            <div className="aspect-video relative">
              <video
                ...
                playsInline
              >
                <source src="/videos/classical-dresser-main.mp4" type="video/mp4" />
                您的浏览器不支持视频播放
              </video>
            </div>
          </div>
